...
class ChangePassword extends Component {
  ...
  handleSubmit = async () => {
    if (this.state.newPass !== this.state.confirmPass) {
      this.setState({
        err: "New password and confirm password are different!",
      });
      return;
    }
    let data = {
            ...
            <div className="user_sidebar">
              <ul className="user_sidebar-list">
                <li className="user_sidebar-list-item">
                  <Link to={"/profile"} className="user_sidebar-list-item-link">
                    <span>Profile</span>
                  </Link>
                </li>
                <li className="user_sidebar-list-item">
          ...
          <div className="change__password">
            <div className="change__password-form">
              ...
              <div className="change__password-item">
                <label
                  className="change__password-item-title"
                  htmlFor="OldPassword"
                >
                  Old Password
                </label>
                <input
                  ...
                  className="change__password-item-input"
                  id="OldPassword<"
                  onChange={(e) => this.onChangeOldPass(e)}
                ></input>
                <span
                  className="change__password-item-icon"
                  onClick={() =>
                    this.setState({
              ...
              <div className="change__password-item">
                ...
                <input
                  ...
                  className="change__password-item-input"
                  id="ConfirmPassword"
                  onChange={(e) => this.onChangeConfirmPass(e)}
                ></input>
                <span
                  className="change__password-item-icon"
                  onClick={() =>
              ...
              <div className="change__password-btn--right">
                <button
                  className="change__password-btn"
