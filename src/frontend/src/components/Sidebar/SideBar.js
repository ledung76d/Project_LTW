            ...
            <div className="accordion" id="accordionExample">
                <div className="accordion-item">
                    ...
                    <div id="collapseOne" className="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                        <div className="accordion-body" onClick={() => this.handleRenderProductByCategory("Fruits")} >
                            Fruits
                        </div>
                        <div className="accordion-body" onClick={() => this.handleRenderProductByCategory("Vegetables")}>
                            Vegetables
                        </div>
                    </div>
                </div>
                <div className="accordion-item">
                    ...
                    <div id="collapseTwo" className="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                        <div className="accordion-body" onClick={() => this.handleRenderProductByCategory("Meat")}>
                            Meat
                        </div>
                        <div className="accordion-body" onClick={() => this.handleRenderProductByCategory("Fish")}>
                            Fish
                        </div>
                    </div>
                </div>
                <div className="accordion-item">
                    ...
                    <div id="collapseThree" className="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                        {links[2].sublinks.map((item, index) => {
                            return (
                                <>
                                    <div className="accordion-body" onClick={() => this.handleRenderProductByCategory(item.text)}>
                                        {item.text}
                                    </div>
                                </>
                            )
