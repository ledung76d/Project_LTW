...
class ProductCart extends Component {
  ...
  render() {
    ...
    return (
      <>
        <button className="cart-btn" onClick={() => this.toggle()}>
          <span className="cart-btn-info">
            <i className="fas fa-shopping-bag cart-btn-icon"></i>
            <span className="cart-btn-quatily">
              {this.props.numberCart} Items
            </span>
          </span>
        ...
        {modal === true ? (
              ...
              <div className=" modal__inner">
                <div className="cart__header">
                  <div className="cart__header-quantity">
                    ...
                    <span className="cart__header-quantity-item">
                      {this.props.numberCart} Item
                    </span>
                  </div>
                  <button
                ...
                <div className="cart__body">
                  {this.props.numberCart === 0 ? (
                    <div className="cart__body-noproduct">
                      <img
                        src={NoProduct}
                        className="cart__body-noproduct-img"
                      />
                      <div className="cart__body-noproduct-title">
                        No products found
                      </div>
                    </div>
                  ) : (
                    <>
                      ...
                      <div className="cart__body-item--not"></div>
                    </>
                  )}
                </div>
                ...
                <div className="cart__footer">
                  ...
                  >
                    <span className="cart__footer-btn-title">Checkout</span>
                    <span className="cart__footer-btn-price">
                      ${this.sumCart()}
                    </span>
                  </button>
                </div>
          ...
          <div
            className={checkOutRight === true ? "cart-modal__outRight" : ""}
          ></div>
        )}
      </>
    );
